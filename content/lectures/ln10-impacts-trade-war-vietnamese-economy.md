...
```mermaid
mindmap
  root(("LN10 — Impacts of Trade War<br/>on Vietnamese Economy"))
    ("L101 Robinson & Thierfelder 2024<br/>Kịch bản CGE chính sách thương mại Mỹ")
      ("Mô hình CGE đa quốc gia: 18 nước/vùng, 24 ngành")
      ("2 kịch bản: thuế đều 10% + leo thang chiến tranh thương mại TQ")
      ("Bảo hộ tạo chi phí lớn, lợi ích hạn chế cho chính Mỹ")
    ("L102 Alessandria et al. 2025<br/>Kỳ vọng thuế quan Mỹ-Trung 2025-2050")
      ("Dynamic exporting model, firms dị biệt")
      ("Xác suất trở lại NTR: >70% (2018) → 21% (2023)")
      ("Bản chất bất định thay đổi qua thời gian trade war")
    ("L103 Che, Lin & Zhang 2025<br/>Tariff evasion & trade deficit")
      ("Input-output table + DiD, EU làm control group")
      ("Trade deficit giảm $110.5 tỷ nhưng 69.70% là evasion, không phải giảm thật")
      ("Trade war KHÔNG hiệu quả như Trump tuyên bố")
    ("L104 Sheng, Song & Zheng 2025<br/>Vertical Trade Diversion Trung Quốc")
      ("⚠️ Slide gốc dán nhầm nội dung — dùng PDF thật")
      ("TQ chuyển hướng xuất khẩu SANG Nam bán cầu, không phải Bắc")
      ("Nâng cấp chất lượng SP khi chuyển hướng — quality ladder")
    ("L105 Almazan-Gomez et al. 2025<br/>Tác động khu vực EU")
      ("297 vùng NUTS-2, partial equilibrium (SMART) + IO đa vùng")
      ("Vùng chuyên môn hóa ô tô/hàng không bị ảnh hưởng nặng nhất")
      ("Khuyến nghị: đa dạng hóa ngành/địa lý, củng cố nội khối EU")
    ("L106 Dang, Yawei & Abdullah 2024<br/>Xuất khẩu VN sang Mỹ — DiD")
      ("UN Comtrade, DiD, cấp 6-digit")
      ("Tổng xuất khẩu VN sang Mỹ TĂNG 14% nhờ trade war")
      ("Hưởng lợi: nhựa, sắt thép, dệt may, máy móc — KHÔNG: điện tử, nông sản")
    ("L107 Toai 2025<br/>Xuất nhập khẩu VN 2020-2024")
      ("Dữ liệu thứ cấp + literature review")
      ("Xuất khẩu VN sang Mỹ tăng >40% 2020-2024")
      ("Rủi ro: mất cân bằng xuất/nhập, phụ thuộc đầu vào TQ, giá trị gia tăng thấp")
```
...
- Mô hình CGE đa quốc gia (18 nước/vùng, 24 ngành) mô phỏng 2 kịch bản chính sách thương mại Mỹ:
  tăng thuế đều 10% và leo thang chiến tranh thương mại với Trung Quốc.<br><span class="en">A
  multi-country CGE model (18 countries/regions, 24 sectors) simulating 2 US trade-policy
  scenarios: a uniform 10% tariff increase and an escalated trade war with China.</span>
- Cả 2 kịch bản đều cho thấy thuế quan KHÔNG bảo vệ được việc làm sản xuất Mỹ; chi phí đầu vào
  ...
  Mỹ.<br><span class="en">Both scenarios show tariffs do NOT protect US manufacturing jobs;
...
- Mô hình dynamic exporting với firm dị biệt ước lượng kỳ vọng thay đổi về thuế quan Mỹ-Trung,
  dùng dữ liệu nhập khẩu Mỹ + EU 2014–2024.<br><span class="en">A dynamic exporting model with
  heterogeneous firms estimating how expectations about US–China tariffs evolved, using US + EU
  import data 2014–2024.</span>
- Xác suất trở lại mức thuế NTR ban đầu >70% nhưng giảm còn 21% vào 2023 — bản chất bất định của
  chính sách thương mại đã thay đổi khi trade war kéo dài qua nhiều đời tổng thống.<br><span
  class="en">The probability of tariffs reverting to NTR levels was initially >70% but fell to
  21% by 2023 — the nature of trade-policy uncertainty changed as the trade war persisted across
  multiple presidencies.</span>
...
- Dùng bảng input-output + DiD (EU làm nhóm đối chứng) đo hành vi né thuế của nhà nhập khẩu Mỹ đối
  với hàng Trung Quốc.<br><span class="en">Uses an input-output table + DiD (with the EU as a
  control group) to measure US importers' tariff-evasion behavior on Chinese goods.</span>
- Thâm hụt thương mại Mỹ–Trung giảm 110.5 tỷ USD sau trade war, nhưng đến 69.70% khoảng chênh lệch
  ...
  thương mại thật.<br><span class="en">The US–China trade deficit fell by USD 110.5 billion after
  the trade war, but up to 69.70% of that gap is due to tariff evasion (underreporting
  values/quantities, product misclassification), not a genuine trade reduction.</span>
...
- ⚠️ Nội dung slide gốc bị dán nhầm — trang wiki dựa trên PDF thật: phân biệt Horizontal Trade
  ...
  xuống nước thu nhập thấp hơn theo bậc thang chất lượng).<br><span class="en">⚠️ The original
  ...
  (VTD, diverting down to lower-income countries along a quality ladder).</span>
- Trái với kỳ vọng thông thường (HTD), Trung Quốc chủ yếu áp dụng chiến lược VTD — chuyển hàng
  chất lượng cao xuống Nam bán cầu, đồng thời nâng cấp chất lượng sản phẩm khi chuyển hướng.<br><span
  class="en">Contrary to conventional expectations (HTD), China primarily adopts the VTD strategy —
...
- Đo tác động khu vực của 2 biện pháp bảo hộ Mỹ chống EU (tranh chấp Boeing-Airbus, thuế 25% ô tô)
  trên 297 vùng NUTS-2 châu Âu, kết hợp partial equilibrium (SMART) + input-output đa vùng.<br><span
  class="en">Measures the regional impact of 2 US protectionist measures against the EU
  (Boeing-Airbus dispute, 25% automotive tariff) across 297 European NUTS-2 regions, combining a
  partial equilibrium model (SMART) + interregional input-output.</span>
- Vùng chuyên môn hóa ô tô/hàng không vũ trụ và tích hợp sâu vào chuỗi giá trị châu Âu bị ảnh hưởng
  nặng nhất; khuyến nghị đa dạng hóa ngành/địa lý và củng cố thương mại nội khối EU.<br><span
  class="en">Regions specialized in automotive/aerospace and deeply embedded in European value
...
- Dùng phương pháp Difference-in-Differences trên dữ liệu UN Comtrade cấp 6-digit để đo tác động
  trade war Mỹ-Trung lên xuất khẩu Việt Nam sang Mỹ.<br><span class="en">Uses a
  Difference-in-Differences approach on HS6-level UN Comtrade data to measure the US–China trade
  war's impact on Vietnamese exports to the US.</span>
- Tổng xuất khẩu Việt Nam sang Mỹ tăng 14% nhờ trade war; ngành hưởng lợi rõ rệt là nhựa, sắt
  ...
  ở L101/L104.<br><span class="en">Vietnam's total exports to the US rose 14% due to the trade
  war; clear beneficiary sectors are plastics, iron/steel, textiles, and machinery — direct
  empirical evidence for the trade-diversion theory in L101/L104.</span>
...
- Phân tích mô tả + tổng quan tài liệu về tác động trade war lên cấu trúc xuất nhập khẩu Việt Nam
  2020–2024, dựa trên dữ liệu thứ cấp.<br><span class="en">A descriptive analysis + literature
...
- Xuất khẩu Việt Nam sang Mỹ tăng >40% (2020–2024), Mỹ trở thành thị trường lớn nhất, nhưng cấu
  ...
  thuộc đầu vào nhập khẩu từ Trung Quốc.<br><span class="en">Vietnamese exports to the US grew
...
1. So sánh 2 khung phương pháp mô phỏng trade war ở tầm toàn cầu —
   ...
   yếu của từng cách tiếp cận.<br><span class="en">Compare 2 global trade-war simulation
   ...
   expectations) — strengths/weaknesses of each approach.</span>
2. Theo [[l103-che-2025-tariff-evasion-trade-war]], vì sao con số "giảm thâm hụt thương mại Mỹ-Trung"
   ...
   góp của nó vào khoảng chênh lệch.<br><span class="en">Per
   ...
   its contribution to the gap.</span>
3. [[l104-sheng-2025-chinese-exporters-trade-diversion]] tìm thấy Trung Quốc dùng chiến lược
   ...
   trực tiếp cho hàng TQ tại thị trường Mỹ, hay cả hai)?<br><span class="en">
   ...
   a direct substitute for Chinese goods in the US market, or both)?</span>
4. So sánh cách tiếp cận đo tác động KHU VỰC/NGÀNH của trade war giữa
   ...
   thấy tác động KHÔNG ĐỒNG ĐỀU, nêu rõ cơ chế gây ra sự không đồng đều ở mỗi bối cảnh.<br><span
   class="en">Compare the regional/sectoral impact-measurement approaches between
   ...
   UNEVEN impacts; specify the mechanism driving unevenness in each context.</span>
5. [[l106-dang-2024-vietnam-exports-us-trade-war-did]] và
   ...
   chặt chẽ hơn của L106.<br><span class="en">Both
...
6. Đây là buổi học cuối cùng của môn — tổng hợp: trong 10 lecture, chủ đề "trade war/protectionism"
   ...
   phản ứng với các cú sốc/áp lực bên ngoài.<br><span class="en">This is the course's final
   ...
   responds to external shocks/pressures.</span>
