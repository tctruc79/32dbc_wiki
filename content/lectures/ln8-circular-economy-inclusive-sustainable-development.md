...
also_covers:
  - "raw/3. LECTURE NOTES/LN8 Circular economy inclusive and sustainable development.zip"   # bản nén y hệt folder LN8 Circular economy inclusive and sustainable development/, đối chiếu listing file khớp qua unzip -l (2026-08-01, ingest LN8)
---
...
sung sau).<br><span class="en">Lecture 8 in [[overview]] (detailed schedule: [[ln0-course-intro]]).
...
trúc bullet điểm chính) → **Kết** (slide 55).<br><span class="en">9 parts per the "Outline of
...
bài (kể cả 2 bài đó) ở phần cuối.<br><span class="en">A notable feature: slides 12-24 (the China
...
individually summarizing all 8 papers (including those 2) at the end.</span>

## Mindmap

```mermaid
mindmap
  root(("LN8 — Circular Economy,<br/>Inclusive and Sustainable<br/>Development"))
    ("L81 Su, Heshmati, Geng & Yu 2013<br/>CE Trung Quốc — case Đại Liên")
      ("So sánh 4 thành phố thí điểm: Đại Liên/Bắc Kinh/Thượng Hải/Thiên Tân 2005-2010")
      ("2 cơ quan quản lý: MEP (EIP) + NDRC (National Pilot CE) — 2 bộ chỉ số riêng")
      ("Thiên Tân tốt nhất tổng thể; Thượng Hải kém nhất dù tăng trưởng kinh tế cao nhất")
    ("L82 Heshmati 2017<br/>Review CE toàn cầu + Entrepreneurship")
      ("Mở rộng L81 ra toàn cầu: Đức, Nhật, EU, Thụy Điển")
      ("Rào cản từ góc nhìn entrepreneurship — literature 'sơ khai' năm 2017")
      ("'Panacea hypothesis': lạc quan quá mức về green entrepreneur, thiếu bằng chứng")
    ("L83 Kirchherr et al. 2018<br/>Rào cản CE ở EU")
      ("Large-N đầu tiên: 208 khảo sát + 47 phỏng vấn chuyên gia")
      ("Rào cản VĂN HÓA đứng đầu (47%, 46%) — rào cản công nghệ đứng CUỐI (15/15)")
      ("Chuỗi phản ứng: giá vật liệu nguyên sinh thấp → thiếu quan tâm tiêu dùng → văn hóa do dự")
    ("L84 García-Barragán et al. 2019<br/>Định nghĩa toán học CE")
      ("Phản ứng vấn đề '114 định nghĩa CE' bằng mô hình tối ưu hóa động")
      ("Chỉ số Cₜ* = Rₜ* − Lₜ*; kinh tế tuần hoàn nếu Cₜ*>0")
      ("Bài lý thuyết/toán học thuần túy — không dữ liệu thực nghiệm")
    ("L85 Saidani et al. 2019<br/>Taxonomy chỉ số CE")
      ("Systematic review: 55 bộ C-indicators hiện có")
      ("Taxonomy 10 danh mục + công cụ Excel 'C-Indicators Advisor'")
      ("90% chỉ số micro có recycling nhưng chỉ 45% bao trùm đủ 3 vòng lặp")
    ("L86 Heshmati & Rashidghalam 2021<br/>CE đô thị Thụy Điển")
      ("PCA 8 thành phần/40 chỉ báo, panel 273 đô thị 2012-2018")
      ("Gotland #1 (88.35); Stockholm CUỐI (29.50) dù là thủ đô")
      ("WCOL (phí rác) hệ số DƯƠNG mạnh nhất; CEI tăng 9.7% qua 7 năm")
    ("L87 Nademi & Sedaghat Kalmarzi 2025<br/>CE và thất nghiệp EU")
      ("Panel GMM 2010-2019: cả 8 chỉ số CE đều giảm thất nghiệp")
      ("2 sub-index mạnh nhất: đầu tư tư nhân CE + thương mại nguyên liệu tái chế")
      ("Khung 'circular justice' — tránh CE làm trầm trọng bất bình đẳng")
    ("L88 Luengo Vera et al. 2025<br/>Innovation-CE-SDG bibliometric")
      ("1630 bài Scopus 2020-2024; co-occurrence + text mining + bibliographic coupling")
      ("Innovation = nút trung tâm; SDG 9/12/13 liên kết chặt nhất")
...
- Review toàn diện CE ở Trung Quốc + case study định lượng: so sánh hiệu suất CE của Đại Liên với
  Bắc Kinh, Thượng Hải, Thiên Tân qua 10 chỉ số 2005–2010.<br><span class="en">A comprehensive
  review of CE in China + a quantitative case study: comparing Dalian's CE performance against
  Beijing, Shanghai, Tianjin via 10 indicators, 2005–2010.</span>
- Trung Quốc quản lý CE qua 2 cơ quan trung ương (MEP, NDRC) công bố 2 bộ chỉ số đánh giá EIP khác
  ...
  nhất — tăng trưởng nhanh không tự động đi kèm quản lý CE tốt.<br><span class="en">China manages
  ...
  — rapid growth does not automatically come with good CE management.</span>
...
- Mở rộng review CE ra toàn cầu (Đức, Nhật, EU, Thụy Điển), bổ sung góc nhìn hoàn toàn mới:
  entrepreneurship và CE như chiến lược phát triển quốc gia đổi mới.<br><span class="en">Expands
  the CE review globally (Germany, Japan, EU, Sweden), adding an entirely new perspective:
  entrepreneurship and CE as an innovative national development strategy.</span>
- "Panacea hypothesis" — niềm tin thiếu bằng chứng rằng entrepreneur xanh sẽ tự động dẫn dắt chuyển
  đổi bền vững; literature entrepreneurship-CE khi đó "còn ở giai đoạn sơ khai".<br><span
  class="en">The "panacea hypothesis" — an unevidenced belief that green entrepreneurs will
  automatically drive sustainable transformation; the entrepreneurship-CE literature was then
  "still in its infant stage."</span>
...
- Nghiên cứu large-N đầu tiên về rào cản CE ở EU (208 khảo sát + 47 phỏng vấn) — **phản bác** quan
  điểm phổ biến rằng rào cản công nghệ là chính.<br><span class="en">The first large-N study on CE
  barriers in the EU (208 surveys + 47 interviews) — **rebutting** the common view that
  technological barriers are primary.</span>
- Rào cản văn hóa (thiếu quan tâm tiêu dùng, văn hóa doanh nghiệp do dự) đứng đầu; rào cản công
  nghệ đứng CUỐI bảng (15/15) — trái ngược hoàn toàn literature cũ.<br><span class="en">Cultural
  barriers (lacking consumer interest, hesitant company culture) rank top; technological barriers
  rank LAST (15/15) — a complete reversal of prior literature.</span>
...
- Bài lý thuyết/toán học thuần túy: xây dựng mô hình tối ưu hóa động dòng vật liệu để định nghĩa
  KHÔNG MƠ HỒ kinh tế tuyến tính/tuần hoàn/tăng trưởng tuần hoàn.<br><span class="en">A purely
  theoretical/mathematical paper: building a dynamic material-flow optimization model to give
  UNAMBIGUOUS definitions of linear/circular/circular-growth economies.</span>
- Chỉ số Cₜ* = hoạt động tái chế tối ưu trừ hoạt động tuyến tính tối ưu; kinh tế tuần hoàn nếu
  Cₜ*>0 — bao trùm cả tái chế lẫn kéo dài vòng đời sản phẩm/mô hình kinh doanh mới.<br><span
  class="en">The metric Cₜ* = optimal recycling activity minus optimal linear activity; the
...
- Systematic review xác định 55 bộ chỉ số đo circularity (C-indicators) hiện có, xây dựng taxonomy
  10 danh mục + công cụ chọn lọc Excel.<br><span class="en">A systematic review identifying 55
...
- 90% chỉ số cấp micro bao gồm recycling nhưng chỉ 45% bao trùm đủ cả 3 vòng lặp CE chính; 60% chỉ
  dùng 1 con số duy nhất để tổng hợp.<br><span class="en">90% of micro-level indicators include
...
- Xây dựng chỉ số CE tổng hợp (CEI, PCA, 8 thành phần/40 chỉ báo) cho 273 đô thị Thụy Điển
  2012–2018, hồi quy panel xác định yếu tố quyết định.<br><span class="en">Building a composite
  CE index (CEI, PCA, 8 components/40 indicators) for 273 Swedish municipalities 2012–2018,
  regressing panel data to identify determinants.</span>
- Gotland xếp #1, Stockholm xếp CUỐI dù là thủ đô phát triển nhất — mật độ dân số cao và thất
  nghiệp làm GIẢM CEI; phí thu gom rác là đòn bẩy chính sách MẠNH NHẤT.<br><span class="en">
...
- Panel GMM 8 mô hình, các nước châu Âu 2010–2019: **tất cả 8 chỉ số CE đều giảm thất nghiệp** có ý
  nghĩa; chỉ số CE tổng hợp (PCA) của nhóm tác giả tác động mạnh nhất.<br><span class="en">Panel
  GMM across 8 models, European countries 2010–2019: **all 8 CE indexes significantly reduce
  unemployment**; the authors' own composite (PCA) CE index has the strongest effect.</span>
- Khung "circular justice" — cảnh báo cần chú ý tác động xã hội tới nhóm yếu thế để tránh CE làm
  trầm trọng bất bình đẳng hiện có.<br><span class="en">A "circular justice" framework — warning
...
- Bibliometric + conceptual analysis 1630 bài báo Scopus 2020–2024 về giao điểm innovation × CE ×
  SDGs — 3 câu hỏi nghiên cứu tường minh về cách innovation kết nối CE với SDG.<br><span
  class="en">A bibliometric + conceptual analysis of 1630 Scopus articles 2020–2024 at the
...
- Innovation là nút trung tâm/"systemic enabler"; Trung Quốc, Anh, Ấn Độ là 3 cực khoa học chính —
  bối cảnh đa cực nhưng không đồng đều.<br><span class="en">Innovation is the central node/
...
1. Kirchherr et al. (2017) tìm thấy 114 định nghĩa CE khác nhau trong literature. Ba bài L83, L84,
   ...
   nhận/loại bỏ/tổ chức hóa sự mơ hồ) và đánh giá ưu-nhược điểm mỗi hướng.<br><span class="en">
   ...
   (accepting/eliminating/organizing the ambiguity) and evaluate the pros/cons of each.</span>
2. So sánh phát hiện về rào cản CE giữa [[l81-su-2013-circular-economy-china]]/
   ...
   độ phát triển kinh tế.<br><span class="en">Compare the CE-barrier findings between
   ...
   explanation based on economic development level.</span>
3. Đối chiếu mô hình quản trị CE của Trung Quốc ([[l81-su-2013-circular-economy-china]], top-down,
   ...
   hơn với bối cảnh thể chế Việt Nam.<br><span class="en">Contrast China's CE governance model
...
4. Theo [[l86-heshmati-rashidghalam-2021-urban-circular-economy-sweden]], vì sao Stockholm (thủ đô
   ...
   Härjedalen) đứng đầu? Nêu cụ thể các biến hồi quy có ý nghĩa giải thích hiện tượng này.<br><span
   class="en">Per [[l86-heshmati-rashidghalam-2021-urban-circular-economy-sweden]], why does
...
5. So sánh phương pháp đo lường/chỉ số tổng hợp PCA dùng bởi
   ...
   ("chữ ký phương pháp luận" của tác giả) và khác biệt biến phụ thuộc/bối cảnh mỗi bài.<br><span
   class="en">Compare the PCA composite-index methodology used by
   [[l86-heshmati-rashidghalam-2021-urban-circular-economy-sweden]] (LN8),
...
6. Theo [[l87-nademi-kalmarzi-2025-circular-economy-unemployment]], CE giảm thất nghiệp châu Âu qua
   ...
   cấp vi mô) — hai phát hiện này có mâu thuẫn không, hay phản ánh khác biệt cấp độ phân tích?<br><span
   class="en">Per [[l87-nademi-kalmarzi-2025-circular-economy-unemployment]], through which
   ...
   findings conflict, or reflect a difference in level of analysis?</span>
7. Theo [[l85-saidani-2019-taxonomy-circular-economy-indicators]], vì sao dùng trực tiếp tỷ lệ tái
   ...
   thích khác biệt giữa "đo hoạt động" và "đo giá trị tối đa hóa".<br><span class="en">Per
   ...
   explain the difference between "measuring activity" and "measuring maximized value."</span>
8. [[l88-vera-2025-innovation-circular-economy-sdgs]] tìm thấy Trung Quốc, Anh, Ấn Độ là 3 cực khoa
   ...
   cố luận điểm gì về vai trò dẫn dắt CE toàn cầu của Trung Quốc?<br><span class="en">
   ...
   global CE leadership does this bibliometric evidence reinforce?</span>
