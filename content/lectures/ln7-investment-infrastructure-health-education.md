...
also_covers:
  - "raw/3. LECTURE NOTES/LN7 Investment in development infrastructure health and education.zip"   # bản nén y hệt folder LN7 Investment in development infrastructure health and education/, đối chiếu listing file khớp qua unzip -l (2026-08-01, ingest LN7)
---
...
giáo dục, y tế) trong cùng một buổi, khác với các LN trước chỉ tập trung 1 chủ đề.<br><span
class="en">Lecture 7 in [[overview]] (detailed schedule: [[ln0-course-intro]]). A 57-page slide
...
quả phân bổ đầu tư công.<br><span class="en">Works through 7 papers in order: Heshmati &
...
```mermaid
mindmap
  root(("LN7 — Investment in Infrastructure,<br/>Health and Education"))
    ("L71 Heshmati & Rashidghalam 2020<br/>Urban Infrastructure China")
      ("PCA: 74 chỉ báo → 15 thành phần → 1 chỉ số tổng hợp")
      ("Panel N=310, 31 tỉnh TQ 2005-2014, R²=0.86 (pooled)/0.99 (FE)")
      ("8/15 thành phần dương có ý nghĩa: economics, employment, HDI, health...")
      ("Guangdong cao nhất/Tibet thấp nhất; chênh lệch Đông-Tây rõ rệt")
    ("L72 Kadyraliev et al. 2022<br/>Transport Infrastructure Kyrgyzstan")
      ("Literature review sâu + case study ODA Kyrgyzstan 1992-2018")
      ("Hồi quy OLS n=7 — KHÔNG có t-stat/R²/ý nghĩa thống kê nào")
      ("Chất lượng đường ODA giảm: 82% tốt (2009) → 34% tốt (2019)")
      ("Đối lập rõ với L71 về độ chặt chẽ phương pháp")
    ("L73 McGuinness et al. 2021<br/>Returns to Education Vietnam")
      ("Mincer + Heckman selection, 5 đợt VHLSS 2002-2016")
      ("Premium ĐH tăng mạnh 2002-2010, ĐẢO CHIỀU giảm ~25pp 2010-2012")
      ("Cầu lao động có trình độ không theo kịp cung sau 2010")
      ("Cảnh báo 'low skills trap' → middle income trap")
    ("L74 Dao & Trinh 2020<br/>Education & Growth Vietnam")
      ("DEA/Malmquist TFP + GMM, VN 2000-2015, mô hình tham chiếu Hua 2005 TQ")
      ("Mô hình TFP THẤT BẠI (adj R²=-0.23); mô hình GDPG thành công (adj R²=0.74)")
      ("CHỈ tiểu học/trung học có ý nghĩa; đại học KHÔNG có ý nghĩa")
      ("Đảo ngược hoàn toàn kết quả Hua (2005): TQ chỉ đại học có ý nghĩa")
    ("L75 Hanushek 2016<br/>Higher Education & Growth")
      ("50 nước 1960-2000: cognitive skills giải thích 73% vs schooling 25%")
      ("Kiểm soát cognitive skills → school attainment MẤT Ý NGHĨA hoàn toàn")
      ("Mỹ là ngoại lệ duy nhất — do thể chế + di dân kỹ năng cao, không phải số năm ĐH")
      ("4 kiểm định nhân quả đều ủng hộ diễn giải nhân quả")
    ("L76 Bloom, Kuhn & Prettner 2018<br/>Health & Economic Growth")
      ("Review toàn diện, Preston curve, 3 vấn đề trung tâm")
      ("Acemoglu & Johnson 2007: sức khỏe → growth ÂM — gây tranh cãi")
      ("Cervellati & Sunde: quan hệ hình chữ U ngược theo demographic transition")
      ("Tác động dương MẠNH NHẤT ở nước nghèo, sức khỏe trẻ em/phụ nữ")
    ("L77 Drama et al. 2025<br/>Public Investment Allocation Efficiency")
      ("DEA + SFA, panel 75 nước đang phát triển 2002-2022")
      ("Y tế 85.37% > Giáo dục 84.79% > Ngành khác 71.94% — đảo ngược mô hình OECD")
      ("Corruption control là yếu tố quyết định hiệu quả MẠNH NHẤT")
...
- Xây dựng chỉ số hạ tầng đô thị tổng hợp bằng PCA (74 chỉ báo → 15 thành phần → 1 chỉ số) cho 31
  ...
  và fixed-effects).<br><span class="en">Builds a composite urban-infrastructure index via PCA
  (74 indicators → 15 components → 1 index) for 31 Chinese provinces 2005–2014, then regresses
  its effect on the urbanization rate (a N=310 panel, pooled OLS and fixed-effects).</span>
- 8/15 thành phần hạ tầng (economics, employment, human development, health, housing, security,
  ...
  có ý nghĩa — "pull factor kinh tế" quan trọng hơn "pull factor phúc lợi gián tiếp".<br><span
  class="en">8/15 infrastructure components (economics, employment, human development, health,
  ...
  "indirect welfare pull factor".</span>
- Chênh lệch tỉnh/vùng rõ rệt (Guangdong cao nhất, Tibet thấp nhất; Eastern region vượt trội) —
  ...
  lực giữa tỉnh giàu/nghèo.<br><span class="en">Marked provincial/regional gaps (Guangdong
...
- Literature review rộng về hạ tầng giao thông–tăng trưởng (Aschauer 1989, Calderon & Servén 2004)
  ...
  (11.2% GDP/năm trung bình).<br><span class="en">A broad literature review on transport
  infrastructure–growth (Aschauer 1989, Calderon & Servén 2004) combined with a Kyrgyzstan case
  study: foreign aid (ODA) 1992–2018 for transport infrastructure (averaging 11.2% of GDP/year).</span>
- Hồi quy thực nghiệm chỉ n=7 quan sát (2013–2019), KHÔNG báo cáo t-stat/R²/kiểm định ý nghĩa nào —
  điểm yếu phương pháp luận rõ rệt, đối lập trực tiếp với độ chặt chẽ của L71.<br><span
  class="en">The empirical regression has only n=7 observations (2013–2019), reporting NO
  t-statistic/R²/significance test whatsoever — a clear methodological weakness, directly
  contrasting with L71's rigor.</span>
- Phát hiện định tính đáng chú ý hơn: chất lượng đường ODA giảm từ 82% "tốt" (2009) xuống 34% "tốt"
  ...
  trước khi hạ tầng hết hạn.<br><span class="en">The more noteworthy findings are qualitative:
  ...
  risk arising before the infrastructure's useful life ends.</span>
...
- Ước lượng suất sinh lời giáo dục (Mincer + Heckman selection) ở Việt Nam qua 5 đợt VHLSS (2002,
  2008, 2010, 2012, 2016), kèm phân tích cầu lao động tương đối (Katz & Autor 1999).<br><span
  class="en">Estimates returns to education (Mincer + Heckman selection) in Vietnam across 5
...
- Phát hiện khúc ngoặt lớn: premium giáo dục ĐH tăng mạnh 2002–2010 (dư cầu lao động có trình độ),
  ...
  2012–2016.<br><span class="en">Finds a major turning point: university-education premiums rose
  sharply 2002–2010 (excess demand for skilled labor), then SHARPLY REVERSED (~25 percentage
  points) 2010–2012 despite the economy STILL growing, stabilizing lower 2012–2016.</span>
- Cảnh báo nguy cơ "low skills trap": premium thấp → giảm động lực đầu tư vốn con người → hút thêm
  FDI kỹ năng thấp → càng giảm premium — có thể góp phần vào middle income trap.<br><span
  class="en">Warns of a "low skills trap" risk: low premiums → reduced human-capital investment
  incentive → attracting more low-skill FDI → further eroding premiums — potentially
  contributing to a middle income trap.</span>
...
- Kiểm định tác động giáo dục (3 bậc) lên tăng trưởng VN 2000–2015, dùng mô hình tham chiếu Hua
  (2005, Trung Quốc): TFP (DEA/Malmquist) + GDP growth, ước lượng GMM.<br><span class="en">Tests
  the effect of education (3 levels) on VN growth 2000–2015, using Hua's (2005, China) reference
  model: TFP (DEA/Malmquist) + GDP growth, GMM estimation.</span>
- Mô hình TFP THẤT BẠI công khai (adjusted R²=−0.23, tác giả tự thừa nhận "questionable"); mô hình
  ...
  ý nghĩa (t=1.079).<br><span class="en">The TFP model FAILS openly (adjusted R²=−0.23, the
  author admits it's "questionable"); the GDPG model succeeds (adjusted R²=0.74) — ONLY primary/
  secondary education are statistically significant, higher education is NOT (t=1.079).</span>
- Đảo ngược hoàn toàn kết quả Hua (2005) cho Trung Quốc (chỉ đại học có ý nghĩa) — bằng chứng
  "returns to education by level" phụ thuộc giai đoạn phát triển, không phải hằng số phổ quát.<br><span
  class="en">Completely reverses Hua's (2005) result for China (only higher education
  significant) — evidence that "returns to education by level" depend on development stage, not
  a universal constant.</span>
...
- Phản biện luận điểm chính sách phổ biến "mở rộng ĐH → tăng trưởng nhanh hơn", dùng dữ liệu tăng
  ...
  toán/khoa học quốc tế) thay vì số năm đi học.<br><span class="en">Rebuts the popular policy
  ...
  scores) instead of years of schooling.</span>
- Cognitive skills giải thích 73.3% biến thiên tăng trưởng (vs 25.2% của school attainment); MỘT
  ...
  toàn.<br><span class="en">Cognitive skills explain 73.3% of growth variation (vs. 25.2% for
  school attainment); ONCE cognitive skills are controlled for, both tertiary and non-tertiary
  schooling LOSE ALL SIGNIFICANCE.</span>
- Mỹ là ngoại lệ duy nhất với tertiary schooling có ý nghĩa (10%) nhưng hoàn toàn do thể chế mạnh +
  ...
  năm học ĐH tự thân.<br><span class="en">The US is the sole exception with significant tertiary
  schooling (10%) but entirely due to strong institutions + attracting highly skilled immigrant
  talent (55% of US STEM PhDs are foreign-born), not years of tertiary schooling itself.</span>
...
- Khảo cứu toàn diện literature lý thuyết + thực nghiệm về quan hệ sức khỏe–tăng trưởng, tổ chức
  ...
  khác biệt theo chiều sức khỏe.<br><span class="en">A comprehensive review of theoretical +
...
- Tranh cãi nổi bật: Acemoglu & Johnson (2007) tìm thấy sức khỏe → growth ÂM (dùng epidemiological
  ...
  hình chữ U ngược).<br><span class="en">A notable dispute: Acemoglu & Johnson (2007) find health
...
- Tác động dương MẠNH NHẤT ở nước kém phát triển giai đoạn post-transition, qua sức khỏe trẻ em/
  ...
  kế an sinh xã hội phù hợp với tuổi thọ tăng.<br><span class="en">The positive effect is
  ...
  social-security designs matching rising longevity.</span>
...
- Đo hiệu quả phân bổ đầu tư công xuyên ngành (giáo dục vs y tế vs khác) trên panel 75 nước đang
  phát triển 2002–2022, dùng đồng thời DEA (phi tham số) + SFA (tham số) + Tobit 2 giai đoạn.<br><span
  class="en">Measures cross-sectoral public-investment allocative efficiency (education vs.
  health vs. other) on a panel of 75 developing countries 2002–2022, using DEA (non-parametric) +
  SFA (parametric) + a two-stage Tobit simultaneously.</span>
- Y tế (85.37%) và giáo dục (84.79%) hiệu quả HƠN ngành khác/hạ tầng (71.94%) — ĐẢO NGƯỢC mô hình
  OECD (Afonso & Aubyn 2006: giáo dục 85% > y tế 72% ở nước giàu).<br><span class="en">Health
...
- **Corruption control là yếu tố quyết định hiệu quả MẠNH NHẤT** (mạnh nhất ở hạ tầng, hệ số 0.085)
  — còn ~16% dư địa cải thiện hiệu quả qua quản trị tốt hơn mà KHÔNG cần thêm ngân sách.<br><span
  class="en">**Corruption control is the STRONGEST efficiency determinant** (strongest for
...
1. Theo Heshmati & Rashidghalam (2020), 8/15 thành phần hạ tầng đô thị có tác động dương có ý
   ...
   KHÔNG có ý nghĩa? Nêu R² của mô hình pooled OLS vs fixed-effects và giải thích chênh lệch.<br><span
   class="en">Per Heshmati & Rashidghalam (2020), which 8/15 urban-infrastructure components have
...
2. So sánh độ chặt chẽ phương pháp luận giữa Heshmati & Rashidghalam (2020, L71, N=310 panel + PCA)
   ...
   production function nhưng độ tin cậy thực nghiệm khác biệt hoàn toàn?<br><span class="en">
...
3. McGuinness et al. (2021) phát hiện suất sinh lời giáo dục đại học ở Việt Nam đảo chiều giảm
   ...
   động có trình độ) và liên hệ với khái niệm "low skills trap"/[[middle-income-trap]].<br><span
   class="en">McGuinness et al. (2021) find Vietnam's higher-education wage return sharply
...
4. Dao & Trinh (2020) dùng mô hình tham chiếu của Hua (2005, Trung Quốc) nhưng thu được kết quả
   ...
   sung cho nhau ở cấp độ nào?<br><span class="en">Dao & Trinh (2020) use Hua's (2005, China)
...
5. Hanushek (2016) lập luận "school attainment" là thước đo vốn con người có sai lệch, và đề xuất
   ...
   ra, và tóm tắt ít nhất 2/4 chiến lược kiểm định nhân quả cognitive skills → growth mà bài dùng.<br><span
   class="en">Hanushek (2016) argues "school attainment" is a biased measure of human capital,
   ...
   cognitive skills → growth the paper uses.</span>
6. Acemoglu & Johnson (2007), được tổng hợp trong Bloom, Kuhn & Prettner (2018, L76), tìm thấy sức
   ...
   demographic transition.<br><span class="en">Acemoglu & Johnson (2007), synthesized in Bloom,
...
7. Drama et al. (2025) tìm thấy y tế/giáo dục hiệu quả HƠN hạ tầng/ngành khác ở nước đang phát
   ...
   tế/giáo dục.<br><span class="en">Drama et al. (2025) find health/education MORE efficient than
   ...
   why "other sectors" (infrastructure) is more corruption-sensitive than health/education.</span>
