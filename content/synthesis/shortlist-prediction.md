...
phần thi viết **06/9** ([[ln0-course-intro]])? Tổng hợp từ [[k31-shortlist-2025]] (văn bản shortlist
CHÍNH THỨC 20 bài mà GS gửi cho khóa K31 năm 2025 — bằng chứng trực tiếp, không phải suy luận),
[[k31-final-exam]] (đề thi thật khóa trước, xác nhận chéo), và [[exam-prep]] (bảng tra cứu 62
paper).<br><span class="en">This page answers: among the 62 deep-ingested papers (LN1–LN10, the
full 10-lecture set), which 20 are most likely to land in the official shortlist Prof. Heshmati
will send on **30/8** for the **06/9** written exam ([[ln0-course-intro]])? Synthesized from
[[k31-shortlist-2025]] (the OFFICIAL 20-paper shortlist document the professor sent to the K31
cohort in 2025 — direct evidence, not inference), [[k31-final-exam]] (the previous cohort's real
exam, used as a cross-check), and [[exam-prep]] (the 62-paper lookup table).</span>

⚠️ **Đây là dự đoán, không phải shortlist thật.** GS chưa công bố shortlist chính thức K32. Trang
này dùng để định hướng ôn thi sớm, PHẢI cập nhật lại khi shortlist thật được công bố 30/8.<br><span
class="en">⚠️ **This is a prediction, not the real shortlist.** The professor has not announced an
...
[[k31-shortlist-2025]] là văn bản "Short list of reading for the written exam in 2025" GS
Heshmati gửi khóa K31 ngày **30/8/2025** — cấu trúc **CỐ ĐỊNH 2 bài Main Reading/lecture × 10
lecture = 20 bài**. Cả 20/20 bài này đều xác nhận có mặt trong 62 paper K32 đã deep-ingest (dù mã
số nội bộ khác nhau giữa 2 khóa — xem bảng đối chiếu đầy đủ trong [[k31-shortlist-2025]]). Xác
nhận chéo với [[k31-final-exam]]: **cả 6/6 câu đề thi thật K31 đều lấy đúng từ 20 bài shortlist
này** (Q1=L42, Q2=L64, Q3=L95, Q4=L31, Q5=L101, Q6=L71 — mã K32).<br><span class="en">
[[k31-shortlist-2025]] is the "Short list of reading for the written exam in 2025" document Prof.
Heshmati sent the K31 cohort on **30/8/2025** — a **FIXED structure of 2 Main Readings/lecture ×
10 lectures = 20 papers**. All 20/20 of these papers are confirmed present among K32's 62
deep-ingested papers (albeit under different internal codes between cohorts — see the full
cross-reference table in [[k31-shortlist-2025]]). Cross-checked against [[k31-final-exam]]: **all
...
- **Đúng cả 2 lần (12 bài)**: L11, L13, L21, L31, L42, L52, L61, L64, L71, L86, L95,
  ...
  L61, L64, L71, L86, L95, L101.</span>
- **Bản cũ chọn SAI (8 bài, nay loại khỏi Top 20)**: L81 (Su, Heshmati — hóa ra GS chọn L86 làm
  đại diện CE của mình chứ không phải cả 2), L83 (Kirchherr — hóa ra GS chọn L84 García-Barragán
  cho mục định nghĩa CE), L26 (Huynh & Tran — hóa ra GS ưu tiên L24 Alesina&Giuliano lý thuyết hơn
  bài áp dụng VN), L96 (Kuosmanen/Heshmati LN9 — hóa ra GS chọn L93 review thay vì bài
  digital-intensity của chính mình), L106 (Dang et al. LN10 — hóa ra GS chọn L107 review thay vì
  bài DiD), L22 (Mauro — không được chọn dù kinh điển), L53 (Naudé — hóa ra GS ưu tiên 2 bài ứng
  dụng VN L51/L52 hơn bài trunk lý thuyết), L77 (Drama — không được chọn).<br><span class="en">
  **The old version picked WRONG (8 papers, now dropped from the Top 20)**: L81 (Su, Heshmati —
  turns out the professor picked L86 as his own CE representative, not both), L83 (Kirchherr —
  turns out the professor picked L84 García-Barragán for the CE-definition slot), L26 (Huynh &
  Tran — turns out the professor prioritizes the theoretical L24 Alesina & Giuliano over the VN
  application paper), L96 (Kuosmanen/Heshmati LN9 — turns out the professor picked the L93 review
  instead of his own digital-intensity paper), L106 (Dang et al. LN10 — turns out the professor
  picked the L107 review instead of the DiD paper), L22 (Mauro — not picked despite being a
  classic), L53 (Naudé — turns out the professor prioritizes the 2 VN application papers L51/L52
  over the theoretical trunk paper), L77 (Drama — not picked).</span>
- **Bản cũ BỎ SÓT (8 bài, nay thêm vào Top 20)**: L24, L32, L45, L51, L73, L84, L93,
  L107.<br><span class="en">**The old version MISSED (8 papers, now added to the Top 20)**: L24,
  L32, L45, L51, L73, L84, L93, L107.</span>
- **Bài học phương pháp**: khi GS chọn giữa nhiều bài "tương đương" trong cùng 1 lecture (vd 2 bài
  CE cùng tác giả L81 vs L86, hoặc bài trunk lý thuyết vs bài ứng dụng VN), xu hướng quan sát được
  là ưu tiên: (a) chỉ 1 bài/tác giả nếu có nhiều bài cùng tác giả trong 1 lecture — KHÔNG chọn cả
  2; (b) với LN5 (khởi nghiệp), ưu tiên 2 bài ỨNG DỤNG VN hơn bài trunk lý thuyết quốc tế; (c) với
  LN2, ngược lại — ưu tiên bài LÝ THUYẾT gốc hơn bài áp dụng VN. Không có quy tắc đơn lẻ áp dụng
  mọi lecture — đây là lý do quan sát trực tiếp (shortlist K31 thật) đáng tin cậy hơn nhiều so với
  quy tắc suy luận chung.<br><span class="en">**Methodological lesson**: when the professor
  chooses among several "equivalent" papers within the same lecture (e.g. 2 same-author CE papers
  L81 vs. L86, or a theoretical trunk paper vs. a VN application paper), the observed tendency is
  to prioritize: (a) only 1 paper per author when multiple same-author papers exist within one
  lecture — NOT both; (b) for LN5 (entrepreneurship), 2 VN APPLICATION papers over the
  international theoretical trunk; (c) for LN2, the opposite — the original THEORY paper over the
