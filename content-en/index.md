...
- **Instructor**: [[almas-heshmati]] (UEH), almas.heshmati@gmail.com.
- **Description**: A survey of Development Issues & Business Cycle topics, balancing theory ↔
  empirics through research papers, with applications to the Vietnamese economy.
- **Base textbook**: Todaro & Smith (2015), *Economic Development*, 12th ed. (TS).
- **Grading**: Essay/Assignment **50%** + Written Exam **50%** — must score ≥50% on EACH part
  to pass.
...
## 10 Lecture Topics (Course Outline)
...
1. **Economic Development** — [[ln1-economic-development]] — readings: Patel et al. 2021
   ...
   Spolaore & Wacziarg 2013 ([[l13-spolaore-2013-deep-roots]]), Sasges & Takahashi 2025
   ([[l14-sasges-2025-vietnam-policies]]), Yin et al. 2025 ([[l15-yin-2025-china-hqed]]).
2. **Governance, Institutions and Policy Making** — [[ln2-governance-institutions-policy-making]]
   — readings: Acemoglu, Johnson & Robinson 2001 ([[l21-acemoglu-2001-colonial-origins]], colonial
   origins), Mauro 1995 ([[l22-mauro-1995-corruption-growth]], corruption), Besley & Ghatak 2010
   ([[l23-besley-ghatak-2010-property-rights]], property rights), Alesina & Giuliano 2015
   ([[l24-alesina-giuliano-2015-culture-institutions]], culture), Bizikova 2025
   ([[l25-bizikova-2025-water-energy-food-nexus]]), Huynh & Tran 2025
   ([[l26-huynh-tran-2025-fdi-informal-economy]]).
3. **Financial Crisis and Pandemics** — [[ln3-financial-crisis-and-pandemics]] — readings:
   Baron, Verner & Xiong 2021 ([[l31-baron-2021-banking-crises-without-panics]]), Jiang, Levine
   & Lin 2019 ([[l32-jiang-2019-competition-bank-liquidity-creation]]), Lastunen & Richiardi
   2023 ([[l33-lastunen-2023-forecasting-covid-recovery-vietnam]], COVID VN), Cai & Le 2023
...
table, cross-paper debates, a concept map, a 61-question bank. [[all-papers-mindmap]] — a
mermaid mindmap of the 10 thematic clusters, complementing the per-slide mindmap on each
lecture page.

**Interactive versions** (all private, click Share on the page if you want to send it to
someone else):
- Bilingual (original version, VI explanation + EN terminology preserved): https://claude.ai/code/artifact/b1704073-2623-44b9-8b64-b0cf8461d866
- Fully Vietnamese: https://claude.ai/code/artifact/c65cd0f4-2ac9-413e-890f-f82651314290
- Fully English (for sending to Prof. Heshmati/international collaborators): https://claude.ai/code/artifact/720594d7-477d-4936-9c9f-f81bf4314f2a
...
Centered on: [[technology-upgrading]], [[middle-income-trap]], [[middle-innovation-trap]],
[[creative-accumulation]] — see [[essays-instructions]].

## Wiki status by lecture

| Lecture | Status |
|---|---|
| 1. Economic Development | Complete — lecture note ([[ln1-economic-development]]) + all 5 readings deep-ingested |
| 2. Governance, Institutions and Policy Making | Complete — lecture note ([[ln2-governance-institutions-policy-making]]) + all 6 readings deep-ingested |
| 3. Financial Crisis and Pandemics | Complete — lecture note ([[ln3-financial-crisis-and-pandemics]]) + all 6 readings deep-ingested (L35, L36 limited by paywall — abstract only) |
| 4. Agriculture, Climate Change and Natural Disasters | Complete — lecture note ([[ln4-agriculture-climate-change-natural-disasters]]) + all 6 readings deep-ingested |
| 5. Entrepreneurship and Economic Development | Complete — lecture note ([[ln5-entrepreneurship-economic-development]]) + all 6 readings deep-ingested |
