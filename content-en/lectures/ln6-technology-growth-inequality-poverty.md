...
also_covers:
  - "raw/3. LECTURE NOTES/LN6 Technology growth inequality and poverty.zip"   # archived copy identical to the LN6 Technology growth inequality and poverty/ folder, file listing cross-checked via unzip -l (2026-08-01, LN6 ingest)
---
...
mindmap
  root(("LN6 — Innovation, Technology,<br/>Growth, Inequality and Poverty"))
    ("L61 Heshmati & Rashidghalam 2020<br/>TFP & Technology Shifters")
      ("190 countries, panel 1996-2013, N=3362 — translog production function")
      ("4 technology shifter indices: infrastructure/finance/technology/human capital")
      ("TC & TFP growth NEGATIVE across ALL income groups — despite positive input elasticities")
      ("Human capital index has the highest elasticity (0.234) among the 4 indices")
    ("L62 Lööf & Heshmati 2006<br/>Innovation and Firm Performance")
      ("Swedish CIS 1996-1998, 3190 firms — CDM knowledge production function")
      ("Simple OLS DOWNWARD-BIASED (0.054) vs. the full-bias-corrected model (0.121)")
      ("Manufacturing and service firms STRIKINGLY SIMILAR")
      ("Register data more reliable than survey data, especially the growth dimension")
    ("L63 Tran, Alkire & Klasen 2015<br/>Monetary vs Multidimensional Poverty VN")
      ("VN household panel 2007/2008/2010, 3 provinces — Alkire-Foster method")
      ("Overlap between the 2 poverty measures <50% — only 1/3 of monetary-poor households are also MD-poor")
      ("Monetary poverty falls CLEARLY faster than MD poverty")
      ("Nutrition + health functioning are the 2 main drivers of MD poverty transitions")
    ("L64 Nguyen & Pham 2018<br/>Growth, Inequality, Poverty VN")
      ("VLSS/VHLSS 1993-2008 — FGT index + Datt-Ravallion decomposition")
      ("1993-98: inequality ROSE, poverty reduction mainly driven by growth")
      ("2004-08: inequality FELL, growth-with-equity — pro-poor index 1.80")
      ("Poverty now more sensitive to inequality THAN to growth")
    ("L65 Nguyen et al. 2019<br/>Energy Transition, Poverty, Inequality VN")
      ("VHLSS 2004-2016, >9000 households/wave — SUREG + Probit")
      ("Clear transition from coal/biomass to gas/electricity — but UNEVEN")
      ("Energy-cost poverty ROSE even as income/consumption/electricity poverty fell")
      ("Energy inequality falls faster than income inequality — except coal/biomass inequality ROSE")
```
...
- A surprising result: TC and TFP growth are **NEGATIVE across ALL country income groups and
  years** in the data-best-supported technology index model (Model 3/TI, weights estimated from
  the data — unlike Model 4/RTI's pre-specified weights; mean TFP −3.6%), despite positive input
  elasticities (labor/capital/energy) and increasing returns to scale.
...
- Full slide-by-slide translation: [[ln6-slides]]
