...
also_covers:
  - "raw/3. LECTURE NOTES/LN5 Entrepreneurship and economic development.zip"   # archived copy identical to the LN5 Entrepreneurship and economic development/ folder, file listing cross-checked via unzip -l (2026-07-29, wiki lint)
---
...
mindmap
  root(("LN5 — Entrepreneurship and<br/>Economic Development"))
    ("L51 Nguyen 2023<br/>EO and Women-Owned SMEs VN")
      ("300 SMEs surveyed, 258 valid — Cronbach's α >0.7")
      ("BP=0.385+0.328Inno+0.301Pro−0.111Risk+0.134Compe+0.220Auto")
      ("Risk-taking NEGATIVE and significant — contradicts standard EO theory")
      ("R²=77% — Innovation is the strongest driver (standardized β=0.339)")
    ("L52 Huis et al. 2019<br/>GET Ahead Training Microfinance VN")
      ("First RCT, TYM Northern VN, 4,041 borrowers at baseline, 3 groups")
      ("Training raises control beliefs + decision-making power over large expenditures")
      ("Effects clear at ENDLINE (12 months), not at midline")
      ("No significant difference when husbands are invited to participate")
    ("L53 Naudé 2010<br/>Entrepreneurship & Development Economics")
      ("TRUNK — introduction to the Small Business Economics special issue")
      ("2 gaps: entrepreneurship undervalued + institutions = a 'black box'")
      ("The problem is ALLOCATION, not a SHORTAGE of entrepreneurship")
      ("Conclusion: understanding the entrepreneur's role = opening the institutions 'black box'")
    ("L54 Méndez-Picazo et al. 2012<br/>Governance, Entrepreneurship, Growth")
      ("Panel of 11 developed countries, 2002-2007, two-equation model")
      ("Governance (PCA of 4 WB dimensions) → positive → entrepreneurship → growth")
      ("Directly cites Acemoglu (2003): 3 necessary institutional characteristics")
      ("Gini positively linked to entrepreneurship — a warning about the equity trade-off")
    ("L55 Stein et al. 2026<br/>Institutional Entrepreneurs, Danish FinTech")
      ("Longitudinal case study, Danish FinTech DEE, 17 in-depth interviews")
      ("3 institutional forces: collaboration, regulation, global connections")
      ("Institutional change = a COLLECTIVE effort, 'neutral leadership' is key")
      ("Opens Naudé's 'black box' with a concrete example of institutional entrepreneurs")
    ("L56 Sharma & Subba 2025<br/>Green Startups & Economic Development")
      ("Scoping review, >100 sources, TBL + EMT framework")
      ("Green startups: job creation, eco-innovation, circular economy")
      ("Barriers: capital, competition, regulation — supportive policy needed")
      ("Gap: lacking longitudinal + cross-national studies + a unified ESG standard")
```
...
- Full slide-by-slide translation: [[ln5-slides]]
