...
also_covers:
  - "raw/3. LECTURE NOTES/LN1 Economic development.zip"   # archived copy identical to the LN1 Economic development/ folder, checksum-verified (2026-07-20)
---
...
mindmap
  root(("LN1 — Economic Development"))
    ("L11 Patel et al. 2021<br/>Unconditional Convergence")
      ...
      ("3 central facts: β flips sign · inverted-U · lower volatility")
      ("Middle-income trap refuted")
      ("Warning: convergence is fragile")
      ("Essay suggestion: VN provincial growth")
    ("L12 Nunn 2019<br/>Rethinking Econ Dev")
      ("Foreign aid critique<br/>49–87% went missing")
      ("Western policy harms<br/>VN catfish case −40% income")
      ("Alternative policy: labour mobility, trade & industrial policy")
      ("Critique of RCTs: ignore local context")
    ("L13 Spolaore & Wacziarg 2013<br/>Deep Roots")
      ("Proximate vs Fundamental determinants")
      ("Geography: 44% income, 71% agriculture")
      ("Reversal of fortune AJR<br/>disappears once Europe is added")
      ("Ancestry adjustment<br/>populations, not locations")
      ("4 channels of intergenerational transmission")
      ("3 messages: persistent · ancestry · not deterministic")
    ("L14 Sasges & Takahashi 2025<br/>Vietnam Policies")
      ("VAR/IRF 1980–2018")
      ("3 policies: electrification · globalization · privatization")
      ("Breakpoint 1997: Period I unstable, Period II stable")
    ("L15 Yin, Bai & Sun 2025<br/>China HQED")
      ("High-speed → High-quality development")
      ("Entropy method, provincial level 2011–2021")
      ("Eastern region outperforms Central/Northeast/West")
```
