...
also_covers:
  - "raw/3. LECTURE NOTES/LN2 Governance institutions and policy making.zip"   # archived copy identical to the LN2 Governance institutions and policy making/ folder, per-file size cross-checked (2026-07-23)
---
...
mindmap
  root(("LN2 — Governance, Institutions<br/>and Policy Making"))
    ("L21 Acemoglu, Johnson & Robinson 2001<br/>Colonial Origins")
      ("Settler mortality → instrument for institutions")
      ("Extractive vs Neo-European institutions")
      ("25% of variation in institutions, 2SLS, J-test")
      ("Examples: East–West Germany, North–South Korea")
      ("Limitation: institutions treated as a black box")
    ("L22 Mauro 1995<br/>Corruption & Growth")
      ("Corruption ↓ investment & growth")
      ("ELF instrument addresses endogeneity")
      ("Singapore vs Zaire")
      ("Bangladesh → Uruguay: +5% investment, +0.5% GDP")
    ("L23 Besley & Ghatak 2010<br/>Property Rights")
      ("Property rights: use, transfer, collateralization")
      ("Endogenous property rights & state effectiveness")
      ("No one-size-fits-all")
    ("L24 Alesina & Giuliano 2015<br/>Culture & Institutions")
      ("Two-way relationship, jointly endogenous")
      ("Measuring culture: survey · 2nd-gen immigrants · experiments")
      ("A/B/C framework: culture→inst · inst→culture · co-evolution")
      ("Gap: interaction mechanisms & causal channels")
    ("L25 Bizikova 2025<br/>Water-Energy-Food Nexus")
      ("Systematic review 683 → 40 papers 2011–2023")
      ("Only 17.5% discuss governance/policy implications")
      ("Gap between technical analysis and policy application")
    ("L26 Huynh & Tran 2025<br/>FDI & Informal Economy VN")
      ("Panel of 63 VN provinces 2006–2021")
      ("FDI ↓ informal economy via growth + governance")
      ("Formal/informal are substitutes")
