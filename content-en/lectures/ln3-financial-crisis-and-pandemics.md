...
also_covers:
  - "raw/3. LECTURE NOTES/LN3 Financial crisis and pandemics.zip"   # archived copy identical to the LN3 Financial crisis and pandemics/ folder, file listing cross-checked via unzip -l (2026-07-25, wiki lint)
---
...
mindmap
  root(("LN3 — Financial Crisis<br/>and Pandemics"))
    ("L31 Baron, Verner & Xiong 2021<br/>Banking Crises without Panics")
      ("Bank equity crash ≥30% predicts GDP -3.4%, credit-to-GDP -5.7pp")
      ("Panic is NOT necessary — non-panic episodes still severe")
      ("Panic occurs AFTER bank equity decline, on average 7 months later")
      ("46 countries, 1870-2016, 27 newly identified forgotten crises")
    ("L32 Jiang, Levine & Lin 2019<br/>Competition and Bank Liquidity Creation")
      ("Competition from deregulation → DECREASES liquidity creation")
      ("1 SD in competition → -3.4pp liquidity creation/assets")
      ("Less profitable banks affected more severely")
    ("L33 Lastunen & Richiardi 2023<br/>Forecasting COVID-19 Recovery Vietnam")
      ("Financial data replacing traditional macro data for nowcasting")
      ("VN forecast closest to GSO, more accurate than IMF/ADB")
    ("L34 Cai & Le 2023<br/>Natural Resources, Financial Development, CSR VN")
      ("Positive long-run, negative short-run relationship with green growth")
      ("PMG-ARDL, Vietnam 1999-2018")
    ("L35 Kakhkharov & Yarashov 2025<br/>Banking, Geopolitical Change")
      ("Review: digitalization + regulatory evolution post-GFC/pandemic")
      ("Emerging-market banks most vulnerable")
    ("L36 Minford 2025<br/>Where Next for Monetary Policy")
      ("3 lessons: stable money supply, fiscal co-option, long-run solvency rules")
      ("Warning against over-tightening once inflation is controlled")
```
