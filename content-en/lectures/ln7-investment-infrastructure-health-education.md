...
also_covers:
  - "raw/3. LECTURE NOTES/LN7 Investment in development infrastructure health and education.zip"   # archived copy identical to the LN7 Investment in development infrastructure health and education/ folder, file listing cross-checked via unzip -l (2026-08-01, LN7 ingest)
---
...
mindmap
  root(("LN7 — Investment in Infrastructure,<br/>Health and Education"))
    ("L71 Heshmati & Rashidghalam 2020<br/>Urban Infrastructure China")
      ("PCA: 74 indicators → 15 components → 1 composite index")
      ("N=310 panel, 31 Chinese provinces 2005-2014, R²=0.86 (pooled)/0.99 (FE)")
      ("8/15 components significantly positive: economics, employment, HDI, health...")
      ("Guangdong highest/Tibet lowest; a stark East-West gap")
    ("L72 Kadyraliev et al. 2022<br/>Transport Infrastructure Kyrgyzstan")
      ("Deep literature review + Kyrgyzstan ODA case study 1992-2018")
      ("OLS regression n=7 — NO t-stat/R²/significance whatsoever")
      ("ODA road quality fell: 82% good (2009) → 34% good (2019)")
      ("Sharp contrast with L71 on methodological rigor")
    ("L73 McGuinness et al. 2021<br/>Returns to Education Vietnam")
      ("Mincer + Heckman selection, 5 VHLSS waves 2002-2016")
      ("University premium rose sharply 2002-2010, REVERSED ~25pp drop 2010-2012")
      ("Demand for skilled labor failed to keep pace with supply after 2010")
      ("Warns of a 'low skills trap' → middle income trap")
    ("L74 Dao & Trinh 2020<br/>Education & Growth Vietnam")
      ("DEA/Malmquist TFP + GMM, VN 2000-2015, reference model Hua 2005 China")
      ("TFP model FAILS (adj R²=-0.23); GDPG model succeeds (adj R²=0.74)")
      ("ONLY primary/secondary significant; higher education NOT significant")
      ("Completely reverses Hua's (2005) result: China only higher education significant")
    ("L75 Hanushek 2016<br/>Higher Education & Growth")
      ("50 countries 1960-2000: cognitive skills explain 73% vs. schooling 25%")
      ("Controlling for cognitive skills → school attainment LOSES significance entirely")
      ("The US is the sole exception — due to institutions + high-skill immigration, not years of tertiary schooling")
      ("All 4 causality tests support a causal interpretation")
    ("L76 Bloom, Kuhn & Prettner 2018<br/>Health & Economic Growth")
      ("A comprehensive review, the Preston curve, 3 central issues")
      ("Acemoglu & Johnson 2007: health → growth NEGATIVE — highly contested")
      ("Cervellati & Sunde: an inverted-U relationship via the demographic transition")
      ("The positive effect is STRONGEST in poor countries, via children's/women's health")
    ("L77 Drama et al. 2025<br/>Public Investment Allocation Efficiency")
      ("DEA + SFA, panel of 75 developing countries 2002-2022")
      ("Health 85.37% > Education 84.79% > Other sectors 71.94% — reversing the OECD pattern")
      ("Corruption control is the STRONGEST efficiency determinant")
      ("~16% efficiency-improvement headroom via better governance, no extra budget needed")
```
...
- Full slide-by-slide translation: [[ln7-slides]]
