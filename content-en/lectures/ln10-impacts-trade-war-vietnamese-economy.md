...
mindmap
  root(("LN10 — Impacts of Trade War<br/>on Vietnamese Economy"))
    ("L101 Robinson & Thierfelder 2024<br/>CGE scenarios of US trade policy")
      ("Multi-country CGE model: 18 countries/regions, 24 sectors")
      ("2 scenarios: uniform 10% tariff + escalated China trade war")
      ("Protectionism creates large costs, limited benefit even for the US itself")
    ("L102 Alessandria et al. 2025<br/>US-China tariff expectations 2025-2050")
      ("Dynamic exporting model, heterogeneous firms")
      ("Probability of NTR reversion: >70% (2018) → 21% (2023)")
      ("The nature of uncertainty changed over the course of the trade war")
    ("L103 Che, Lin & Zhang 2025<br/>Tariff evasion & trade deficit")
      ("Input-output table + DiD, EU as control group")
      ("Trade deficit fell $110.5bn but 69.70% is evasion, not a real reduction")
      ("The trade war is NOT as effective as Trump claimed")
    ("L104 Sheng, Song & Zheng 2025<br/>China's Vertical Trade Diversion")
      ("⚠️ Original slide mispastes content — based on the real PDF")
      ("China diverts exports TO the Global South, not the North")
      ("Upgrades product quality while diverting — a quality ladder")
    ("L105 Almazan-Gomez et al. 2025<br/>EU regional impact")
      ("297 NUTS-2 regions, partial equilibrium (SMART) + multiregional IO")
      ("Regions specialized in automotive/aerospace hit hardest")
      ("Recommends: sectoral/geographic diversification, strengthening intra-EU trade")
    ("L106 Dang, Yawei & Abdullah 2024<br/>Vietnamese exports to the US — DiD")
      ("UN Comtrade, DiD, 6-digit level")
      ("Vietnam's total exports to the US ROSE 14% due to the trade war")
      ("Beneficiaries: plastics, iron/steel, textiles, machinery — NOT: electronics, agriculture")
    ("L107 Toai 2025<br/>Vietnam's imports and exports 2020-2024")
      ("Secondary data + literature review")
      ("Vietnamese exports to the US grew >40% 2020-2024")
      ("Risks: export/import imbalance, dependence on Chinese inputs, low value-added")
```
