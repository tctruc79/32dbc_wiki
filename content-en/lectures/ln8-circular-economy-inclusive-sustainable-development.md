...
also_covers:
  - "raw/3. LECTURE NOTES/LN8 Circular economy inclusive and sustainable development.zip"   # archived copy identical to the LN8 Circular economy inclusive and sustainable development/ folder, file listing cross-checked via unzip -l (2026-08-01, LN8 ingest)
---
...
mindmap
  root(("LN8 — Circular Economy,<br/>Inclusive and Sustainable<br/>Development"))
    ("L81 Su, Heshmati, Geng & Yu 2013<br/>CE China — the Dalian case")
      ("Comparing 4 pilot cities: Dalian/Beijing/Shanghai/Tianjin 2005-2010")
      ("2 regulatory agencies: MEP (EIP) + NDRC (National Pilot CE) — 2 separate indicator sets")
      ("Tianjin best overall; Shanghai worst despite the highest economic growth")
    ("L82 Heshmati 2017<br/>Global CE Review + Entrepreneurship")
      ("Expands L81 globally: Germany, Japan, EU, Sweden")
      ("Barriers from an entrepreneurship lens — literature 'in its infant stage' in 2017")
      ("'Panacea hypothesis': excessive optimism about green entrepreneurs, lacking evidence")
    ("L83 Kirchherr et al. 2018<br/>CE Barriers in the EU")
      ("First large-N study: 208 surveys + 47 expert interviews")
      ("CULTURAL barriers rank top (47%, 46%) — technological barriers rank LAST (15/15)")
      ("Chain reaction: low virgin-material prices → lacking consumer interest → hesitant culture")
    ("L84 García-Barragán et al. 2019<br/>A Mathematical Definition of CE")
      ("Responds to the '114 CE definitions' problem with a dynamic optimization model")
      ("Metric Cₜ* = Rₜ* − Lₜ*; the economy is circular if Cₜ*>0")
      ("A purely theoretical/mathematical paper — no empirical data")
    ("L85 Saidani et al. 2019<br/>A Taxonomy of CE Indicators")
      ("Systematic review: 55 existing sets of C-indicators")
      ("10-category taxonomy + an Excel 'C-Indicators Advisor' tool")
      ("90% of micro indicators include recycling but only 45% cover all 3 loops")
    ("L86 Heshmati & Rashidghalam 2021<br/>Urban CE in Sweden")
      ("PCA, 8 components/40 indicators, panel of 273 municipalities 2012-2018")
      ("Gotland #1 (88.35); Stockholm LAST (29.50) despite being the capital")
      ("WCOL (waste-collection charge) the strongest POSITIVE coefficient; CEI up 9.7% over 7 years")
    ("L87 Nademi & Sedaghat Kalmarzi 2025<br/>CE and Unemployment in the EU")
      ("Panel GMM 2010-2019: all 8 CE indexes reduce unemployment")
      ("2 strongest sub-indexes: CE private investment + trade in recyclable raw materials")
      ("A 'circular justice' framework — avoiding CE worsening inequality")
    ("L88 Luengo Vera et al. 2025<br/>Innovation-CE-SDG Bibliometric Analysis")
      ("1630 Scopus articles 2020-2024; co-occurrence + text mining + bibliographic coupling")
      ("Innovation = the central node; SDG 9/12/13 the most tightly linked")
      ("China, the UK, India = 3 multipolar scientific poles")
```
